...
*/
		...
		define("TB_FOLDERS", "Carpetas");
 		define("TB_FOLDERNAME", "Nombre de la carpeta");
		...
		define("TB_EDDENIED", "Necesitas permisos de edición o borrado para ver esta página.");
 		define("TB_FODENIED", "Necesitas permisos de administración de carpetas para ver esta página.");
?>
