...
$tinybrowser['obfuscate'] = 'f53e8b73-76c3-4254-a457-96cd48e81a25';


// Set default language (ISO 639-1 code)
$tinybrowser['language'] = 'es';
...
$tinybrowser['path']['image'] = '/app/webroot/userdata/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/app/webroot/userdata/media/'; // Media files location
$tinybrowser['path']['file']  = '/app/webroot/userdata/files/'; // Other files location
...
$tinybrowser['link']['image'] = '/userdata/images/'; // Image links
$tinybrowser['link']['media'] = '/userdata/media/'; // Media links
$tinybrowser['link']['file']  = '/userdata/files/';// Other file links
