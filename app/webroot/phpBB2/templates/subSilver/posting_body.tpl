		...
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr> 
			<td colspan="9"><span class="gen"> 
			  <textarea name="message" rows="15" cols="35" wrap="virtual" style="width:450px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeydown="limitText(this.form.message,this.form.countdown,500);" onkeyup="storeCaret(this); limitText(this.form.message,this.form.countdown,500);">{MESSAGE}</textarea>
			  <font size="1">(M&aacute;ximo n&uacute;mero de caracteres: 500)<br>
                          Quedan <input readonly type="text" name="countdown" size="3" value="500"> caracteres.</font>
                          </span></td>
		  </tr>
		</table>
		</span></td>
