...
// DEFINE("CACHE_DIR","/tmp/jpgraph_cache/");
	...
	//[DAWES] La ruta debe ser absoluta. Uso una variable global de php para buscar la raiz.
	$auxiliar = explode("app",$_SERVER["SCRIPT_FILENAME"]);
	DEFINE("TTF_DIR",$auxiliar[0]."app/fonts/");
	
	//DEFINE("TTF_DIR","app/fonts/");
	//DEFINE("TTF_DIR",$_SERVER["DOCUMENT_ROOT"]."/chileunido/app/fonts/");
